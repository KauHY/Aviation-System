...
def convert_csv_to_json():
    ...
    default_csv_path = os.path.join(os.path.dirname(repo_root), '机场信息.csv')
    fallback_csv_path = r'd:\BlockChain\机场信息.csv'
    csv_path = default_csv_path if os.path.exists(default_csv_path) else fallback_csv_path
    json_path = os.path.join(repo_root, 'backend', 'airports.json')
